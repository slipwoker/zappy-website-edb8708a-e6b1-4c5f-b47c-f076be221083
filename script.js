    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "מכירת כרטיסים במחיר עלות משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'edb8708a-e6b1-4c5f-b47c-f076be221083',
                    name: data.name || '',
                    email: data.email || '',
